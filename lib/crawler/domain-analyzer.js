...
export async function analyzeDomain(domainUrl) {
    try {
        ...
        console.error(`Domain analysis failed for ${domainUrl} (continuing anyway):`, error.message)
        // Return success=true so we proceed to homepage crawling/extraction anyway
        return {
            success: true,
            error: error.message,
            robotsTxt: null,
